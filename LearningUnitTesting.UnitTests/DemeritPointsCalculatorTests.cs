...
namespace LearningUnitTesting.UnitTests
{
    ...
    public class DemeritPointsCalculatorTests
    {
        ...
        [TestCase(-1)]
        [TestCase(301)]
        public void CalculateDetermitPoints_SpeedIsOutOfRange_ThrowExeption(int speed)
        {
        ...
        [TestCase(70,1)]
        [TestCase(75,2)]
        public void CalculateDetermitPoints_WhenCalled_ReturnDemeritPoints(int speed, int expectedResult)
        {
            var calculator = new DemeritPointsCalculator();
